...
if Z==sum(strcmp(subjs(s),'SPM2')) && Z==sum(strcmp(conds(c),'decline_150')) 
           start_values = find(forces_df.FP1For(:,2)> (500+nanmean(forces_df.FP1For(300,2))),1);
           start_value_pref = start_values;
elseif Z==sum(strcmp(subjs(s),'SPM4')) && Z==sum(strcmp(conds(c),'incline_050')) 
           start_values = find(forces_df.FP1For(:,2)> (150+nanmean(forces_df.FP1For(300,2))),1);
           start_value_pref = start_values;
elseif Z==sum(strcmp(subjs(s),'SPM4')) && Z==sum(strcmp(conds(c),'decline_150')) 
           start_values = find(forces_df.FP1For(:,2)> (400+nanmean(forces_df.FP1For(300,2))),1);
           start_value_pref = start_values;
else    
% start_names = {'level_050'};
start_values = find(forces_df.FP1For(:,2)> (200+nanmean(forces_df.FP1For(300,2))),1);
...
%% STD Method 
[STV_OP1_value,STV_OP1_median_value,STV_OP1_steadypoint_value_all,STV_OP1_steadypoint_value] = stdmethod(stride_speed_all(1:275));
...
title([subjs{s} ' ' conds{c}])
yyaxis left
plot(1:length(stride_speed_all(1:269)),stride_speed_all(1:269),'.-'); 
xlim([0 269])
hold on 
scatter(STV_OP1_steadypoint_value_all,stride_speed_all(STV_OP1_steadypoint_value_all),'.r')
ylabel('Stride Speed')
yyaxis right 
plot(STV_OP1.level.STDvalues((1:269),s),'.-');
ylim([0 0.15])
ylabel('STD Values')
...
patch('Faces',[1 2 3 4],'Vertices',[0 0;0 STV_OP1.level.medianvalue(:,s);269 STV_OP1.level.medianvalue(:,s);269 0],'FaceColor','red','FaceAlpha',.3); 
...
% [speed_strides] = compile_speed(stride_speed_all(1:275),s,c);
% Stride Speed 
     if c == 1
     speed_strides.level_050(s,:) = stride_speed_all(1:275);
     end
     if c == 2
     speed_strides.level_100(s,:) = stride_speed_all(1:275);
     end
     if c == 3
     speed_strides.level_150(s,:) = stride_speed_all(1:275);
     end
     
     if c == 4
     speed_strides.incline_050(s,:) =  stride_speed_all(1:275);
     end
     if c == 5
     speed_strides.incline_100(s,:) =  stride_speed_all(1:275);
     end
     if c == 6
     speed_strides.incline_150(s,:) =  stride_speed_all(1:275);
     end
     
     if c == 7
     speed_strides.decline_050(s,:) = stride_speed_all(1:275);
     end
     if c == 8
     speed_strides.decline_100(s,:) =  stride_speed_all(1:275);
     end
     if c == 9
     speed_strides.decline_150(s,:) =  stride_speed_all(1:275);
     end
 
% Stride Length  
     if c == 1
     length_strides.level_050(s,:) = stridelength_all(1:275);
     end
     if c == 2
     length_strides.level_100(s,:) = stridelength_all(1:275);
     end
     if c == 3
     length_strides.level_150(s,:) = stridelength_all(1:275);
     end
     
     if c == 4
     length_strides.incline_050(s,:) =  stridelength_all(1:275);
     end
     if c == 5
     length_strides.incline_100(s,:) =  stridelength_all(1:275);
     end
     if c == 6
     length_strides.incline_150(s,:) =  stridelength_all(1:275);
     end
     
     if c == 7
     length_strides.decline_050(s,:) = stridelength_all(1:275);
     end
     if c == 8
     length_strides.decline_100(s,:) =  stridelength_all(1:275);
     end
     if c == 9
     length_strides.decline_150(s,:) =  stridelength_all(1:275);
     end
     
% Stride Width  
     if c == 1
     width_strides.level_050(s,:) = stridewidth_all(1:275);
     end
     if c == 2
     width_strides.level_100(s,:) = stridewidth_all(1:275);
     end
     if c == 3
     width_strides.level_150(s,:) = stridewidth_all(1:275);
     end
     
     if c == 4
     width_strides.incline_050(s,:) =  stridewidth_all(1:275);
     end
     if c == 5
     width_strides.incline_100(s,:) =  stridewidth_all(1:275);
     end
     if c == 6
     width_strides.incline_150(s,:) = stridewidth_all(1:275);
     end
     
     if c == 7
     width_strides.decline_050(s,:) = stridewidth_all(1:275);
     end
     if c == 8
     width_strides.decline_100(s,:) =  stridewidth_all(1:275);
     end
     if c == 9
     width_strides.decline_150(s,:) =  stridewidth_all(1:275);
     end

% Stride Time  
     if c == 1
     time_strides.level_050(s,:) = stridelength_all(1:275);
     end
     if c == 2
     time_strides.level_100(s,:) = stridelength_all(1:275);
     end
     if c == 3
    time_strides.level_150(s,:) = stridelength_all(1:275);
     end
     
     if c == 4
     time_strides.incline_050(s,:) = stridelength_all(1:275);
     end
     if c == 5
     time_strides.incline_100(s,:) =  stridelength_all(1:275);
     end
     if c == 6
     time_strides.incline_150(s,:) = stridelength_all(1:275);
     end
     
     if c == 7
     time_strides.decline_050(s,:) = stridelength_all(1:275);
     end
     if c == 8
     time_strides.decline_100(s,:) = stridelength_all(1:275);
     end
     if c == 9
     time_stridess.decline_150(s,:) =  stridelength_all(1:275);
     end
%    
%      
%      
%      if c == 1
%      time_strides.level(s,:) = stridelength_all(STV_OP1.level.steadystatevalue(s):(STV_OP1.level.steadystatevalue(s)+275));
%      end
%      if c == 2
%      time_strides.incline(s,:) = stridelength_all(STV_OP1.incline.steadystatevalue(s):(STV_OP1.incline.steadystatevalue(s)+275));
%      end
%      if c == 3
%      time_strides.decline(s,:) = stridelength_all(STV_OP1.decline.steadystatevalue(s):(STV_OP1.decline.steadystatevalue(s)+275));
%      end
% %% BEST FIT MODEL 
% % v = 0.5:0.1:1.8;
% %     figure(100)
...
%      if c == 1
%      [P,fh] = fitsinglemodelprocess_sl(length_strides.level(s,:),speed_strides.level_050(s,:));
%      end 
%      if c == 2
%      [P,fh] = fitsinglemodelprocess_sl(length_strides.incline(s,:),speed_strides.incline_050(s,:));
%      end 
%      if c == 3
%      [P,fh] = fitsinglemodelprocess_sl(length_strides.decline(s,:),speed_strides.decline_050(s,:));
%      end 
     
      if c == 1
     [P,fh] = fitsinglemodelprocess_sl(length_strides.level_050(s,:),speed_strides.level_050(s,:));
     end
     if c == 2
     [P,fh] = fitsinglemodelprocess_sl(length_strides.level_100(s,:),speed_strides.level_100(s,:));
     end
     if c == 3
     [P,fh] = fitsinglemodelprocess_sl(length_strides.level_150(s,:),speed_strides.level_150(s,:));
     end
     
     if c == 4
     [P,fh] = fitsinglemodelprocess_sl(length_strides.incline_050(s,:),speed_strides.incline_050(s,:));
     end
     if c == 5
     [P,fh] = fitsinglemodelprocess_sl(length_strides.incline_100(s,:),speed_strides.incline_100(s,:));
     end
     if c == 6
     [P,fh] = fitsinglemodelprocess_sl(length_strides.incline_150(s,:),speed_strides.incline_150(s,:));
     end
     
     if c == 7
     [P,fh] = fitsinglemodelprocess_sl(length_strides.decline_050(s,:),speed_strides.decline_050(s,:));
     end
     if c == 8
     [P,fh] = fitsinglemodelprocess_sl(length_strides.decline_100(s,:),speed_strides.decline_100(s,:));
     end
     if c == 9
     [P,fh] = fitsinglemodelprocess_sl(length_strides.decline_150(s,:),speed_strides.decline_150(s,:));
     end
...
%     plot(v,fh(v,P),'Color',color(c,:));
    ...
    p.decline_150(s,:) = P;
     ...
     if c == 1
     variation_strides.level_050.slminusfit(s,:) = var(length_strides.level_050(s,:) - fh(speed_strides.level_050(s,:),P));
     variation_strides.level_050.speedtrend(s,:) = var(fh(speed_strides.level_050(s,:),P));
     variation_strides.level_050.totalvar(s,:) = var(length_strides.level_050(s,:));
     end
     if c == 2
     variation_strides.level_100.slminusfit(s,:) = var(length_strides.level_100(s,:) - fh(speed_strides.level_100(s,:),P));
     variation_strides.level_100.speedtrend(s,:) = var(fh(speed_strides.level_100(s,:),P));
     variation_strides.level_100.totalvar(s,:) = var(length_strides.level_100(s,:));
     end
     if c == 3
     variation_strides.level_150.slminusfit(s,:) =  var(length_strides.level_150(s,:) - fh(speed_strides.level_150(s,:),P));
     variation_strides.level_150.speedtrend(s,:) = var(fh(speed_strides.level_150(s,:),P));
     variation_strides.level_150.totalvar(s,:) = var(length_strides.level_150(s,:));
     end
     
     if c == 4
     variation_strides.incline_050.slminusfit(s,:) = var(length_strides.incline_050(s,:) - fh(speed_strides.incline_050(s,:),P));
     variation_strides.incline_050.speedtrend(s,:) = var(fh(speed_strides.incline_050(s,:),P));
     variation_strides.incline_050.totalvar(s,:) = var(length_strides.incline_050(s,:));
     end
     if c == 5
     variation_strides.incline_100.slminusfit(s,:) = var(length_strides.incline_100(s,:) - fh(speed_strides.incline_100(s,:),P));
     variation_strides.incline_100.speedtrend(s,:) = var(fh(speed_strides.incline_100(s,:),P));
     variation_strides.incline_100.totalvar(s,:) = var(length_strides.incline_100(s,:));
     end
     if c == 6
     variation_strides.incline_150.slminusfit(s,:) =  var(length_strides.incline_150(s,:) - fh(speed_strides.incline_150(s,:),P));
     variation_strides.incline_150.speedtrend(s,:) = var(fh(speed_strides.incline_150(s,:),P));
     variation_strides.incline_150.totalvar(s,:) = var(length_strides.incline_150(s,:));
     end
     
     if c == 7
     variation_strides.decline_050.slminusfit(s,:) = var(length_strides.decline_050(s,:) - fh(speed_strides.decline_050(s,:),P));
     variation_strides.decline_050.speedtrend(s,:) = var(fh(speed_strides.decline_050(s,:),P));
     variation_strides.decline_050.totalvar(s,:) = var(length_strides.decline_050(s,:));
     end
     if c == 8
     variation_strides.decline_100.slminusfit(s,:) = var(length_strides.decline_100(s,:) - fh(speed_strides.decline_100(s,:),P));
     variation_strides.decline_100.speedtrend(s,:) = var(fh(speed_strides.decline_100(s,:),P));
     variation_strides.decline_100.totalvar(s,:) = var(length_strides.decline_100(s,:));
     end
     if c == 9
     variation_strides.decline_150.slminusfit(s,:) =  var(length_strides.decline_150(s,:) - fh(speed_strides.decline_150(s,:),P));
     variation_strides.decline_150.speedtrend(s,:) = var(fh(speed_strides.decline_150(s,:),P));
     variation_strides.decline_150.totalvar(s,:) = var(length_strides.decline_150(s,:));
     end
     
%% FINDING VARIABILITY FOR STRIDE WIDTH
%      if c == 1
%      [W,fh_width] = fitsinglemodelprocess_sw(width_strides.level(s,:),speed_strides.level_050(s,:));
%      end 
%      if c == 2
%      [W,fh_width] = fitsinglemodelprocess_sw(width_strides.incline(s,:),speed_strides.incline_050(s,:));
%      end 
%      if c == 3
%      [W,fh_width] = fitsinglemodelprocess_sw(width_strides.decline(s,:),speed_strides.decline_050(s,:));
%      end 
% %     plot(v,fh(v,P),'Color',color(c,:));
%     if c == 1 
%     p.level_width(s,:) = W;
...
%% SPEEDS 
% speed_for_slopes(c) = nanmean(stride_speed_all(150:294));
