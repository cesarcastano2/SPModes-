function[RHS,LTO,LHS,RTO,GE,GEInMiddleDeleted] = GaitEvents_allslopes(Time, llmarkers, markers4GE, HSrefinePre, HSrefinePost, TOminpeakdistance, TOminpeakheight,BW)   
% Inputs are:
